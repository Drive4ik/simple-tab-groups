...
export default {
    ...
    async mounted() {
        ...
        log.log('loaded');
        console.log('loaded', startUpData);
    ...
    >
        <header class="is-flex is-align-items-center">
            ...
            <div class="is-full-width has-text-right">
                <button class="button" @click="addParent" @contextmenu="$refs.newGroupContextMenu.open($event)">
                    <span class="icon">
                        ...
                        <div v-if="unSyncTabs.length" class="group">
                            ...
                            'in-list-view': !options.showTabsWithThumbnailsInManageGroups,
                                ...
                                >
                                    ...
                                    <div class="delete-tab-button" @click.stop="removeTab(tab)"
